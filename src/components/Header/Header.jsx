        ...
        <header>
            ...
            <nav className='desktop-nav'>
                <ul className='desktop-nav-lista'>
                    ...
                    <li className='desktop-nav-item'><Link to="/guia-de-talles">Guía de talles</Link></li>
            ...
            <div className='mobile-header'>
                <nav className='mobile-nav mobile-container' id='nav'>
                    ...
                    <ul className='mobile-nav-lista'>
                        ...
                        <li className='mobile-nav-item'><Link to="/guia-de-talles" className='mobile-nav-link'>Guía de talles</Link></li>
